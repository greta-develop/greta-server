...
class TransactionController extends Controller
{
    ...
    public function show(string $url) {
        return Transaction::select('handling as content', 'transaction_amount as amount', 'title as detail', 'balance as balance', 'transaction_date as date',
            ...
            DB::raw("(CASE WHEN (replies.transaction_id = transactions.id) && (replies.status = 'A') THEN 'Answered' WHEN (replies.transaction_id = transactions.id) && (replies.status = 'U') THEN 'Unanswerd' ELSE 'Nothing' END) as reply"))
